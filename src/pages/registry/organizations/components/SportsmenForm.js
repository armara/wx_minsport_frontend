...
import { selectOrganizationSportsmenPositions } from 'store/selectors/groups/groups'
...
const SportsmenForm = ({ sportsmenForEdit, submit, positions }) => (
  <Form
    onSubmit={submit}
    initialValues={sportsmenForEdit}
  ...
  >
    <>
      ...
      <FormControlButtons
        onCancelClick={() => history.push('/organizations/registry/sportsmens')}
      />
      <ToolTip />
    </>
  </Form>
...
SportsmenForm.propTypes = {
  submit: PropTypes.func.isRequired,
  sportsmenForEdit: PropTypes.shape({}),
...
const mapStateToProps = state => ({
  positions: selectOrganizationSportsmenPositions(state),
})
